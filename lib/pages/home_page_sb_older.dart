...
//   void loadData() async {
//     List<Todo> loadedTodos = await todoRepo.getAll();
...
//   void deleteTask(String index) async {
//     await todoRepo.delete(index);
//     loadData();
//   }

//   void editDate(String index) async {
//     DateTime? pickedDate = await showDatePicker(
//       context: context,
//       firstDate: DateTime(2024, 3, 18),
//       lastDate: DateTime(2030, 3, 18),
...
//   void editName(String taskName, String index) async {
//     await todoRepo.editName(taskName, Stri);
//     loadData();
//   }
